...
function createNotifier(opts, log) {
  ...
  // Latin-1 — un tiret cadratin, un accent, un emoji — et `fetch` lève
  // « Cannot convert argument to a ByteString », l'envoi échoue, la file
  // gonfle et se retente à l'infini sans jamais passer. Le corps, lui, part en
  // UTF-8 sans souci ; seuls les en-têtes sont concernés. ntfy sait décoder
  // l'« encoded-word » RFC 2047, on s'en sert dès qu'un titre sort de l'ASCII.
