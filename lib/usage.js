// COPIE PARTAGÉE — le fichier de référence vit dans signalk-autopolar.
// Il est recopié à l'identique dans les autres plugins (signalk-ac42-autopilot,
// et les suivants) : `cmp` doit rester silencieux entre les copies. Toute
// correction se fait ici, puis se recopie — deux versions qui divergent
// compteraient deux choses différentes sous le même nom. Le style peut donc
// détonner avec le plugin qui l'héberge, c'est le prix de l'identité.
